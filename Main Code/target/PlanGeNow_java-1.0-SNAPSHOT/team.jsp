<%-- 
    Document   : team
    Created on : 18 Dec 2024, 11:02:38 pm
    Author     : varsh
--%>
    ...
    <div class="mainContent">
        <div class="sidebar">
            <div class="sidebarOptions sidebarOptionActive">
                ...
                <a href="javascript:void(0)" class="navLink"><div class="sidebarOptionsText">My Teams</div></a>
            </div>
        ...
        <div class="mainContainer">
            <div class="mainSection">
                <div class="columnHeaderBar">
                    ...
                    <div class="columnHeader">Team</div>
                </div>
                <div class="projectListSection">
                    <div class="singleProjectSection">
                        <div class="projectBar">
                            <div class="projectDetail projectDetailGroup"><img src="./assets/star.png" class="starIcon whiteStar"><img
                                    src="./assets/starYellow.png" class="starIcon yellowStar"><a class="projectPageLink"
                                    href="welcomepage.html">
                                    <div>Project 1</div><img src="./assets/external-link.png" class="linkIcon">
                                </a></div>
                            <div class="projectDetail">Team-managed</div>
                        ...
                        <div class="projectTeamSection">
                            ...
                            <div class="teamRow">
                                <div class="teamMember">
                                    <div class="teamMemberIcon"><div>PC</div></div>
                                ...
                                <div class="teamMemberContact">
                                    <div class="teamMemberEmail">p.chowdhury@oth-aw.de</div>
                                    <div class="teamMemberNumber">+49-123456789</div>
                                </div>
                            </div>
                            <div class="teamRow">
                                <div class="teamMember">
                                    <div class="teamMemberIcon"><div>TD</div></div>
                                    <div class="teamMemberName">Tanay Dubey</div>
                                </div>
                                <div class="teamMemberRoleSection">
                                    <div class="teamMemberRole">Frontent Developer </div>
                                    <div class="teamMemberRole">Git Manager</div>
                                </div>
                                <div class="teamMemberContact">
                                    <div class="teamMemberEmail">t.dubey@oth-aw.de</div>
                                    <div class="teamMemberNumber">+49-123456789</div>
                                </div>
                            </div>
                            <div class="teamRow">
                                <div class="teamMember">
                                    <div class="teamMemberIcon"><div>VB</div></div>
                                    <div class="teamMemberName">Varshil Balar</div>
                                </div>
                                <div class="teamMemberRoleSection">
                                    <div class="teamMemberRole">Backend Developer </div>
                                    <div class="teamMemberRole">Database Developer</div>
                                
                                </div>
                                <div class="teamMemberContact">
                                    <div class="teamMemberEmail">v.balar@oth-aw.de</div>
                                    <div class="teamMemberNumber">+49-123456789</div>
                                </div>
                            </div>
                            <div class="teamRow">
                                <div class="teamMember">
                                    <div class="teamMemberIcon"><div>AM</div></div>
                                    <div class="teamMemberName">Ahmed Muddasir</div>
                                </div>
                                <div class="teamMemberRoleSection">
                                    <div class="teamMemberRole">Backend Developer</div>
                                    <div class="teamMemberRole">Database Developer</div>
                                ...
                                <div class="teamMemberContact">
                                    <div class="teamMemberEmail">a.muddasir@oth-aw.de</div>
                                    <div class="teamMemberNumber">+49-123456789</div>
                                </div>
                            </div>
                            <div class="teamRow">
                                <div class="teamMember">
                                    <div class="teamMemberIcon"><div>PJ</div></div>
                                    <div class="teamMemberName">Prajwol Joshi</div>
                                </div>
                                <div class="teamMemberRoleSection">
                                    <div class="teamMemberRole">Frontend Developer </div>
    
                                </div>
                                <div class="teamMemberContact">
                                    <div class="teamMemberEmail">p.joshi@oth-aw.de</div>
                                    <div class="teamMemberNumber">+49-123456789</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="singleProjectSection">
                        ...
                        <div class="projectTeamSection">
                            ...
                            <div class="teamRow">
                                <div class="teamMember">
                                    <div class="teamMemberIcon"><div>RB</div></div>
                                    <div class="teamMemberName">Rutvik Balar</div>
                                </div>
                                <div class="teamMemberRoleSection">
                                    <div class="teamMemberRole">Frontend Developer </div>
                                ...
                                <div class="teamMemberContact">
                                    <div class="teamMemberEmail">r.balar@oth-aw.de</div>
                                    <div class="teamMemberNumber">+49-123456789</div>
                                </div>
                            </div>
                            <div class="teamRow">
                                <div class="teamMember">
                                    <div class="teamMemberIcon"><div>AT</div></div>
                                    <div class="teamMemberName">Aabha Tembe</div>
                                </div>
                                <div class="teamMemberRoleSection">
                                    <div class="teamMemberRole">Project Tester </div>
                                    
                                </div>
                                <div class="teamMemberContact">
                                    <div class="teamMemberEmail">a.tembe@oth-aw.de</div>
                                    <div class="teamMemberNumber">+49-123456789</div>
                                </div>
                            </div>
                            <div class="teamRow">
                                <div class="teamMember">
                                    <div class="teamMemberIcon"><div>KS</div></div>
                                    <div class="teamMemberName">Kumar Sai</div>
                                </div>
                                <div class="teamMemberRoleSection">
                                    <div class="teamMemberRole">Project Tester </div>
                                ...
                                <div class="teamMemberContact">
                                    <div class="teamMemberEmail">k.sai@oth-aw.de</div>
                                    <div class="teamMemberNumber">+49-123456789</div>
                                </div>
                            </div>
                        </div>
